package com.wangwenjun.concurrency.second.classloader.chapter2;
...
public class BootClassLoader {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Class<?> klass = Class.forName("com.wangwenjun.concurrency.second.classloader.chapter2.SimpleObject");
